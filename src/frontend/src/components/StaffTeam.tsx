...
const staffMembers = [
  {
    ...
    roleIcon: Crown,
    description:
      "Founder and visionary behind AstralWorld. Building the ultimate LifeSteal adventure since day one.",
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Meet the dedicated team keeping AstralWorld running smoothly
          </p>
        </div>
