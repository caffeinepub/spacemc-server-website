...
const staffMembers = [
  {
    ...
    role: "Owner",
    roleIcon: Crown,
    description: "Founder and visionary behind DomainMC. Building the ultimate space adventure since day one.",
    color: "oklch(0.80 0.18 85)",
    glowColor: "oklch(0.80 0.18 85 / 0.4)",
  ...
  },
  {
    ...
    role: "Staff",
    roleIcon: Shield,
    description: "Dedicated staff member keeping the galaxy safe and helping players on their cosmic journey.",
    color: "oklch(0.72 0.18 195)",
    glowColor: "oklch(0.72 0.18 195 / 0.4)",
    borderColor: "oklch(0.52 0.18 195)",
    bgColor: "oklch(0.72 0.18 195 / 0.08)",
    avatarBg: "linear-gradient(135deg, oklch(0.55 0.25 240), oklch(0.72 0.18 195))",
    avatarInitial: "HR",
    badge: "STAFF",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Meet the dedicated team keeping DomainMC running smoothly"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-8 justify-center items-stretch", children: staffMembers.map((member) => {
